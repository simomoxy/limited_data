...
class ECGResNet(nn.Module):
    ...
    def __init__(self, base_model, out_dim, widen=1.0, big_input=False, use_meta_information_in_head=False):
        ...
        self.resnet_dict = {"xresnet1d18": xresnet1d18(widen=widen),
                            "xresnet1d18_deep": xresnet1d18_deep(widen=widen),
                            "xresnet1d18_deeper": xresnet1d18_deeper(widen=widen),
                            "xresnet1d34": xresnet1d34(widen=widen),
                            "xresnet1d34_deep": xresnet1d34_deep(widen=widen),
                            "xresnet1d34_deeper": xresnet1d34_deeper(widen=widen),
                            "xresnet1d50": xresnet1d50(widen=widen),
                            "xresnet1d50_deep": xresnet1d50_deep(widen=widen),
                            "xresnet1d50_deeper": xresnet1d50_deeper(widen=widen),
