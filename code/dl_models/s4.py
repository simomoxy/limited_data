...
def cauchy_conj(v, z, w, backend='GPU'):
    """ Pykeops version """
...
class SSKernelNPLR(nn.Module):
    ...
    def forward(self, state=None, rate=1.0, L=None):
        ...
        if has_cauchy_extension and z.dtype == torch.cfloat:
            ...
            r = cauchy_conj(v, z, w, self.backend)
    ...
    def __init__(
        ...
        **kernel_args,
        ...
        self.kernel = HippoSSKernel(
            self.h, N=self.n, L=l_max, channels=channels, verbose=verbose, backend=backend, **kernel_args)
